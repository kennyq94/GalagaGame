...
public abstract class Entity {
  ...
  /**
   * The current life of this entity
   */
  protected int life = 1;
  /**
   * The current age of entity, really only for turrets
   */
  protected int age = 1;
  /**
  The last time the entity was permitted to fire
  */
